...
must_haves:
  ...
  key_links:
    - from: "tests/unit/test_projection/test_refractive.py"
      to: "src/aquakit/projection/refractive.py"
    ...
    - from: "tests/unit/test_projection/test_protocol.py"
      to: "src/aquakit/projection/protocol.py"
...
Import `ProjectionModel` from `aquakit.projection` and `RefractiveProjectionModel` from `aquakit.projection`.
  </action>
  <verify>

...
Import types from `aquakit.types`: `CameraIntrinsics`, `CameraExtrinsics`.
...
Run `python -c "from aquakit import create_camera"` — import succeeds.
  </verify>
  <done>

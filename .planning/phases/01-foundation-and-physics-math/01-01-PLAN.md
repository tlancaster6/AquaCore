...
must_haves:
  truths:
    - "User can import CameraIntrinsics, CameraExtrinsics, InterfaceParams, Vec2, Vec3, Mat3 from aquakit and construct instances with typed fields"
...
Run `python -c "from aquakit import CameraIntrinsics, CameraExtrinsics, InterfaceParams, Vec2, Vec3, Mat3, rvec_to_matrix"` — imports succeed.
  </verify>
  <done>
...
3. `python -c "from aquakit import CameraIntrinsics, Vec3, rvec_to_matrix, ray_plane_intersection"` — imports succeed
